...
class TestElixir(unittest.TestCase):
    ...
    @patch('mock_exercise.requests.get')
    def test_get_elixir(self, mock_get):
        mock_response = Mock()
        mock_dict = {'id': '568f24eb-55e6-4899-bd3b-8631118572b9', 'name': 'Hate Potion', 'effect': 'Revealed the worst traits of a person to the drinker',
        ...
        mock_get.assert_called_with(
            'https://wizard-world-api.herokuapp.com/Elixirs/0')
